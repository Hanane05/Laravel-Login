                    ...
                    <form  action="{{route('file.update', $file)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">  
                                ...
                                <div class="col-12 mt-4">
                                    ...
                                    <input type="text" id="title" name="titre" class="form-control" value="{{ $file->titre}}">
                                </div>
                                
                                <div class="col-12 mt-4">
                                    <label for="title_fr">@lang('lang.titreFichier')</label>
                                    <input type="text" id="title_fr" name="titre_fr" class="form-control" value="{{ $file->titre_fr}}">
                                </div>
